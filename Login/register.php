	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form action="registerprocess.php" method="POST" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter email">
						<input class="input100" type="text" name="email" placeholder="email" re>
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
					...
					<div class="container-login100-form-btn m-t-32">
						<button class="login100-form-btn" id="register_auser" name="register_auser">
							Register
						</button>
					</div>
